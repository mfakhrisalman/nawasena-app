                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                      ...
                      <div class="z-index-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="/"><img src="assets/img/logo.png" alt="" width="200"></a>
                        <p class="opacity-75 text-white"></p>
                      </div>
                    </div>
                    <div class="mt-3 mb-4 mt-md-4 mb-md-5 light">
                      <p class="text-white"><br><a class="text-decoration-underline link-light" href="/register">Get started!</a></p>
                    </div>
                  </div>
