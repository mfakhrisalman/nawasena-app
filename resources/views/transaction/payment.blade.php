...
@else
            ...
            <div class="d-flex justify-content-center">
                <a class="btn btn-falcon-success btn-sm mb-3" type="button" href="/payment/{{ $transaction->id }}/pay">
                    <span class="" data-fa-transform="shrink-3 down-2">
                      </span><span class="ms-1">Pay</span>
                    </a>
            </div>
          </td>
@endcan
