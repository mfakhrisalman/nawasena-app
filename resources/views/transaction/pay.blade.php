@extends('layout.main')
@section('container')
<form method="post" action="/payment/{{ $transaction->id }}" enctype="multipart/form-data">
    @method('put')
    @csrf
    <div class="mb-2">
        <div class="row">
    ...
    <div class="mb-2">
      ...
      <div class="mb-3">
          <img src="{{ asset('storage/' . $transaction->receipt) }}" alt="Previous Image" style="max-width: 100px;" />
      </div>
      @else
      @endif
      <div class="mb-3">
      ...
      <input type="hidden" name="status" value="waiting for confirmation">
